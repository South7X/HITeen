package com.hitsz.eatut.datepicker;
...
public class CustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public CustomDatePicker(Context context, Callback callback, String beginDateStr, String endDateStr, String currentDateStr) {
        this(context, callback, DateFormatUtils.str2Long(beginDateStr, true),
                DateFormatUtils.str2Long(endDateStr, true),
                DateFormatUtils.str2Long(currentDateStr, true));
    }
     ...
     */
    public CustomDatePicker(Context context, Callback callback, long beginTimestamp, long endTimestamp, long currentTimestamp) {
        ...
        initView();
        initData();
        mCallback.onTimeSelected(currentTimestamp);//对mCallBack中的timeStamp初始化
        mCanDialogShow = true;
    }

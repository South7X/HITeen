...
public class AAYAxis {
    ...
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPlotBandsElement[] plotBands;
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPlotLinesElement[] plotLines;
    ...
    public com.hitsz.eatut.AAChartCoreLib.AAOptionsModel.AALabels labels;//用于设置 y 轴文字相关的
    ...
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AACrosshair crosshair;  //准星线样式设置
    ...
    public AAYAxis plotBands(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPlotBandsElement[] prop) {
        plotBands = prop;
        return this;
    }

    public AAYAxis plotLines(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPlotLinesElement[] prop) {
        plotLines = prop;
        return this;
    }
    ...
    public AAYAxis labels(com.hitsz.eatut.AAChartCoreLib.AAOptionsModel.AALabels prop) {
        labels = prop;
        return this;
    }
    ...
    public AAYAxis crosshair(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AACrosshair prop) {
        crosshair = prop;
        return this;
    }

...
public class AAChart {
    ...
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAScrollablePlotArea scrollablePlotArea;
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAResetZoomButton resetZoomButton;
    ...
    public AAChart animation(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAAnimation prop) {
        animation = prop;
        return this;
    }
    ...
    public AAChart scrollablePlotArea(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAScrollablePlotArea prop) {
        scrollablePlotArea = prop;
        return this;
    }

    public AAChart resetZoomButton(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAResetZoomButton prop) {

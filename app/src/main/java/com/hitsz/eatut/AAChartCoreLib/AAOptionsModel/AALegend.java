...
public class AALegend {
    ...
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAItemStyle itemStyle;
    public Float x;
    public Float y;
    ...
    public AALegend itemStyle(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAItemStyle prop) {
        itemStyle = prop;
        return this;
    }

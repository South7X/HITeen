...
public class AALabels {
    ...
    public com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAStyle style;//轴标签的 CSS 样式
    ...
    public AALabels style(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAStyle prop) {
        style =  prop;
        return this;
    }

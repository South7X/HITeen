...
package com.hitsz.eatut.AAChartCoreLib.AAChartCreator;
...
public class AAChartView extends WebView {
    ...
    public interface AAChartViewCallBack {
        ...
        void chartViewMoveOverEventMessage(
                ...
                com.example.anan.AAChartCore.AAChartCoreLib.AAChartCreator.AAMoveOverEventMessageModel messageModel
        );
    }
    ...
    public String androidMethod(String message) {
        ...
        com.example.anan.AAChartCore.AAChartCoreLib.AAChartCreator.AAMoveOverEventMessageModel eventMessageModel = getEventMessageModel(messageBody);
        if (callBack != null) {
...
//       Log.i("androidMethod","++++++++++++++++显示总共调用了几次");
    ...
    public void aa_drawChartWithChartModel(final com.hitsz.eatut.AAChartCoreLib.AAChartCreator.AAChartModel chartModel) {
        AAOptions aaOptions = com.hitsz.eatut.AAChartCoreLib.AAChartCreator.AAOptionsConstructor.configureChartOptions(chartModel);
        this.aa_drawChartWithChartOptions(aaOptions);
    }

    public void aa_refreshChartWithChartModel(com.hitsz.eatut.AAChartCoreLib.AAChartCreator.AAChartModel chartModel) {
        AAOptions aaOptions = com.hitsz.eatut.AAChartCoreLib.AAChartCreator.AAOptionsConstructor.configureChartOptions(chartModel);
    ...
    public void aa_onlyRefreshTheChartDataWithChartOptionsSeriesArray(
            com.hitsz.eatut.AAChartCoreLib.AAChartCreator.AASeriesElement[] seriesElementsArr
    ) {
    ...
    public void aa_addElementToChartSeries(com.hitsz.eatut.AAChartCoreLib.AAChartCreator.AASeriesElement aaSeriesElement) {
...
//                Log.i("js files load","图表加载完成!!!!!!!! ");
    ...
    private com.example.anan.AAChartCore.AAChartCoreLib.AAChartCreator.AAMoveOverEventMessageModel getEventMessageModel(Map messageBody) {
        com.example.anan.AAChartCore.AAChartCoreLib.AAChartCreator.AAMoveOverEventMessageModel eventMessageModel =  new com.example.anan.AAChartCore.AAChartCoreLib.AAChartCreator.AAMoveOverEventMessageModel();

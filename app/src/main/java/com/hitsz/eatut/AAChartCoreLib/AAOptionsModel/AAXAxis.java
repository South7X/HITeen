...
public class AAXAxis {
    ...
    public AAXAxis plotBands(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPlotBandsElement[] prop) {
        plotBands = prop;
        return this;
    }

    public AAXAxis plotLines(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AAPlotLinesElement[] prop) {
        plotLines = prop;
        return this;
    }
    ...
    public AAXAxis crosshair(com.example.anan.AAChartCore.AAChartCoreLib.AAOptionsModel.AACrosshair prop) {
        crosshair = prop;
        return this;
    }
